...
if not getgenv().AirTeam or getgenv().AirTeam.Aimbot then return end
...
local Environment = getgenv().AirTeam.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().AirTeam.Aimbot.Functions = nil
	getgenv().AirTeam.Aimbot = nil
