...
if not getgenv().AirTeam or getgenv().AirTeam.WallHack then return end
...
local Environment = getgenv().AirTeam.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().AirTeam.WallHack.Functions = nil
	getgenv().AirTeam.WallHack = nil
